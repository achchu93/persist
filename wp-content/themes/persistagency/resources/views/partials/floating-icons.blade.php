@if (!empty($email) && $show_email)
  <div class="floating-icons__email fixed z-10 hidden md:block">
...
@if ($show_floating_social_icons)
  <div class="floating-icons__social fixed z-10 flex flex-col items-center mr-8 right-0 space-y-5 hidden md:block">
    @if (!empty($instagram))
