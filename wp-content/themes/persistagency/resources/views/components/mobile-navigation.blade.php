<div class="bg-black bg-cover duration-500 ease-in-out fixed flex flex-col h-screen mobile-menu overflow-hidden overflow-y-scroll right-0 text-white top-0 transform w-100 z-50 w-screen p-4 translate-x-full" style="background-image:url('{{ $mobile_navigation_background['url'] }}')">
