<div class="bg-black bg-cover duration-500 ease-in-out fixed flex flex-col h-screen mobile-menu overflow-hidden overflow-y-scroll right-0 text-white top-0 transform w-100 z-50 translate-x-full"
     style="background-image:url('{{ $mobile_navigation_background['url'] }}')" 
  >
  <div class="w-screen p-4"> 
    <svg 
       ...
       viewBox="0 0 352 512" 
       class="mobile-menu__toggle absolute h-6 mr-5 right-0 w-6 cursor-pointer text-white mt-16"
       >
