<div class="block md:hidden bg-black bg-cover duration-500 ease-in-out fixed flex flex-col h-screen mobile-menu overflow-hidden overflow-y-scroll right-0 text-white top-0 transform w-100 z-50 w-screen p-4 translate-x-full" style="background-image:url('<?php echo e($mobile_navigation_background['url']); ?>')">
...
<?php /**PATH C:\xampp\htdocs\persist\wp-content\themes\persistagency\resources\views/components/mobile-navigation.blade.php ENDPATH**/ ?>