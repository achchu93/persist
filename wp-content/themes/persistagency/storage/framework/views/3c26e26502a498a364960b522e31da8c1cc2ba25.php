<header class="absolute w-full z-10">
  <div class="container flex flex-col items-start justify-between md:flex-row md:py-2 mx-auto px-5">
    <a href="<?php echo e($home_url); ?>" title="<?php echo e($site_name); ?>" class="md:ml-0 md:mt-0 md:px-0 md:w-auto mt-3 px-3 w-64">
...
<?php /**PATH /Applications/MAMP/htdocs/persist/wp-content/themes/persistagency/resources/views/partials/header.blade.php ENDPATH**/ ?>