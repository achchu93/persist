<div class="<?php echo e($class); ?> block-case-studies-list overflow-hidden">
    ...
    <?php if($items): ?>
      <div class="flex flex-col lg:mt-16 md:mt-10 mt-8 space-y-16 xl:mt-20 xl:space-y-24">
        ...
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="<?php echo e($item['class']); ?> item anim-in scroll-fade-in">
            ...
            <div class="<?php echo e($item['reverse']?'md:flex-row-reverse':'md:flex-row '); ?> flex flex-col flex-wrap justify-center w-full h-full py-4">
              ...
              <?php if($item['illustration']): ?>
                <div class="md:w-7/12 relative <?php echo e($item['reverse']?'slide-from-right':'slide-from-left '); ?>">
                  <?php echo wp_get_attachment_image($item['illustration']['id'], 'full', false, ['class' => 'w-full h-auto']); ?>

                </div>
              <?php endif; ?>

              <div class="md:w-5/12 <?php echo e($item['reverse']?'slide-from-left':'slide-from-right '); ?>">
...
<?php /**PATH C:\xampp\htdocs\persist\wp-content\themes\persistagency\resources\views/blocks/block-case-studies-list.blade.php ENDPATH**/ ?>