<div class="flex items-center space-x-5">
  ...
  <?php if(!empty($instagram)): ?>
    <a href="<?php echo $instagram; ?>" rel="noopener" target="_blank">
  ...
  <?php if(!empty($twitter)): ?>
    <a href="https://twitter.com/<?php echo $twitter; ?>" rel="noopener" target="_blank">
  ...
  <?php if(!empty($facebook)): ?>
    <a href="<?php echo $facebook; ?>" rel="noopener" target="_blank">
  ...
  <?php if(!empty($linkedin)): ?>
    <a href="<?php echo $linkedin; ?>" rel="noopener" target="_blank">
...
<?php /**PATH /Applications/MAMP/htdocs/persist/wp-content/themes/persistagency/resources/views/components/social-icons.blade.php ENDPATH**/ ?>