...
?>
  <?php $__currentLoopData = $navigation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
    <li class="navigation relative inline-block sm:mx-2 md:mx-4 lg:mx-8 xl:mx-16 <?php echo e($item->classes ?? ''); ?> <?php echo e($item->active ? 'active' : ''); ?> <?php echo e($item->children? 'navigation__has-submenu':''); ?> slide" style="--index: <?php echo e(++$count); ?>;"> 
      <a 
...
<?php /**PATH C:\xampp\htdocs\persist\wp-content\themes\persistagency\resources\views/components/navigation.blade.php ENDPATH**/ ?>