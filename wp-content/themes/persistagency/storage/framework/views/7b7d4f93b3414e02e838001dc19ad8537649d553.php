            ...
            <div class="">
              ...
              <?php if(!empty($stat['number'])): ?>
                <div class="bg-fill font-brushup inline-block leading-none mt-4 px-6 relative text-7xl text-yellow uppercase xl:text-12xl z-10" style="background-image:url('<?= \Roots\asset('images/brush-red-big.png'); ?>')">
                  <div class="xl:-translate-y-5 transform xl:translate-x-3 stats-value"><?php echo e($stat['number']); ?></div>
                </div>
              <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\persist\wp-content\themes\persistagency\resources\views/blocks/block-story-stats.blade.php ENDPATH**/ ?>